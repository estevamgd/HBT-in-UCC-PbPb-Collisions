...
#include "data_func.h"
#include "my_func.h"
#include "sig_sl_utn.h"

void sig_sl_utn(const char *fileInput, const char *treeInput, int selectionVarI, int selectionVarF, int poolSize = 10) {
    ...
    // Prefix
    char prefix[50]; 
    sprintf(prefix, "sig_sl_utn_%s_%d-%d", selectionVarName, selectionVarI, selectionVarF);
