...
void sig_sl(const char *fileInput, const char *treeInput, int selectionVarI, int selectionVarF, int poolSize = 10) {
    ...
    // Prefix
    char prefix[50]; 
    sprintf(prefix, "sig_sl_%s_%d-%d", selectionVarName, selectionVarI, selectionVarF);
