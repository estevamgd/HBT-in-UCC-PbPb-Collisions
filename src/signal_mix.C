...
void sig_single_loop(const char *fileInput, const char *treeInput, double selVarMoreeq, double selVarLess, 
    ...
    char prefix[50];
    sprintf(prefix, "sig_single_loop_%s_%f-%f", selectionVarName, displaySelVarMoreeq, displaySelVarLess);
...
void sig_double_loop(const char *fileInput, const char *treeInput, double selVarMoreeq, double selVarLess, 
    ControlVar selectionVarType = ControlVar::CENT) {
...
void executeSigMix(){
    ...
    std::vector<double> centralityBins = {3200, 3300, 3500, 3800}; 
    // Example for more bins: std::vector<double> centralityBins = {0, 10, 30, 50, 70, 90};
    // to test: 3200-3300, 3300-3500, 3500-3800
    ...
    */
    ...
    for (size_t i = 0; i < centralityBins.size() - 1; ++i){
        ...
        // For method timing test:
        sig_single_loop(inputFile, treeName, bin_low, bin_high, selectedControlVar);
        sig_double_loop(inputFile, treeName, bin_low, bin_high, selectedControlVar);
    }
